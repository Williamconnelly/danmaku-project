...
// Boolean objects of pressed or non-pressed key states. When true, a movement command is issued.
//Player 1 Inputs
var move = {
	up: false,
	down: false,
...
var createPowerUp = function() {
	...
	powerUp = new GameObject(getRandomNumber(80, gameWidth - 160), 0, 50, 50, "transparent", 1, 5000, powerDiv);
